...
async function GET(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserModel"].findById(claims.userId);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["syncAdminRole"])(user);
        const payload = {
            user: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$userProfile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toUserProfile"])(user)
        };
        if (user.role !== roleBefore || user.role !== claims.role) {
            payload.token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signToken"])({
                userId: user._id.toString(),
                email: user.email,
                role: user.role
            });
...
async function PATCH(req) {
    try {
        ...
        /* Bidder → seller upgrade only; privileges require admin approval */ if (body.role === 'seller' && user.role === 'bidder') {
            allowed.role = 'seller';
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserModel"].findByIdAndUpdate(claims.userId, {
            $set: allowed
        }, {
            new: true,
            runValidators: true
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$userProfile$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toUserProfile"])(updated)
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80d5c580._.js.map