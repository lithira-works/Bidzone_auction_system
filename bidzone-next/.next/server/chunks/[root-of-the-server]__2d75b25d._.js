module.exports = [
"[project]/.next-internal/server/app/api/admin/auctions/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/auctions/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        const auction = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Auction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuctionModel"].findById(id);
        if (!auction) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (body.moderationStatus && [
            ...
            'approved',
            'rejected'
        ].includes(body.moderationStatus)) {
        ...
        if (body.auctionEndsAt != null) {
            ...
            updates.timeLeft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auctionTime$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatTimeLeftCompact"])(body.auctionEndsAt);
        }
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Auction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuctionModel"].findByIdAndUpdate(id, {
            $set: updates
        }, {
            new: true
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            auction: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auctionMapper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toAdminAuctionSummary"])(updated)
        });
    } catch (err) {
...
async function DELETE(req, { params }) {
    try {
        ...
        const { id } = await params;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
        const auction = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Auction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuctionModel"].findByIdAndDelete(id);
        if (!auction) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Auction not found'
            }, {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Bid$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BidModel"].deleteMany({
            auctionId: id
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d75b25d._.js.map